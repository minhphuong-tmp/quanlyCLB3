...
const _Input = styled.input`
  border: 0;
  border-bottom: 2px solid rgb(236, 139, 122);
  outline: 0;
...
const _Button = styled.button`
  ...
  margin-left: 70px;
  height: 40px;
  background-color:rgb(236, 139, 122);
  color: white;
  border: none;
  border-radius: 10px;
  font-size: 1.8rem;
...
const Line2 = styled.div`
  ...
  width: 450px;
  height: 350px;
//  border: 4px solid rgb(236, 139, 122);
  border-radius: 50%;
  right: -6.5rem;
  bottom: -6rem;
  opacity: 0.8;
  ...
  submit = async (event) => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        sessionStorage.setItem("userId2", res.data.userId2);
        console.log("sesssion storage userid2:", res.data.userId2)
