    ...
    return (
      <div className='container'>
        ...
        <Site>
          ...
          <Gpa_site>
            <Title_gpa>Thời gian</Title_gpa>
            <p>Tổng thời gian:</p>
            <label>{sum_of_credits}/100</label>
            <br />
            <progress min='0' max='158' value={sum_of_credits}></progress>
            <p style={{ marginTop: "30px" }}>Thời gian trung bình :</p>
            <label>{gpa}</label>
            <p>Trạng thái: </p>
            <label
              className={
        ...
        <Btn_site>
          ...
          <button
            ...
            style={{
              marginRight: "20px",
              backgroundColor: "rgb(236, 139, 122)",
              borderColor: "rgb(236, 139, 122)"
            }}
