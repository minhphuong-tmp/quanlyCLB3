...
class Chart extends Component {
  ...
  render() {
    ...
    //pie-chart
    var data_pie_chart = [
      { name: "Ít tham gia", value: 0 },
      { name: "Trung bình", value: 0 },
      { name: "Đều đặn", value: 0 },
      { name: "Nhiệt tình", value: 0 },
      ...
      <Container>
        ...
        <Chart2>
          <h3 style={{ textAlign: "center" }}>
            BIỂU ĐỒ THỐNG KÊ THỜI GIAN HOẠT ĐỘNG CLUB
          </h3>
          <Center2>
        ...
        <Chart1>
          <h3 style={{ textAlign: "center" }}>
            BIỂU ĐỒ THỐNG KÊ TRẠNG THÁI THÀNH VIÊN
          </h3>
          <Center1>
